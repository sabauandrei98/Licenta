...
public class GameDebuggerWindow : MonoBehaviour
{
    ...
    void Start()
    {
        GameObject.FindGameObjectWithTag("Debug_Button").GetComponent<Button>().onClick.AddListener(delegate { DebugMap(); });
        debug_panel = GameObject.FindGameObjectWithTag("Debug_Panel");
    }
